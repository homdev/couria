...
const PricingPlan = (props) => {
    ...
    return (
        <Card className='max-w-sm shadow-none border border-black rounded-lg mt-3 px-14 py-5 dark:bg-black dark:border-white'>
            ...
            >{sessionStorage.getItem('auth') === null || sessionStorage.getItem('type') === 'Gratuit' ? "Commencer" : "Modifier l'abonnement'"}
            </button>
        </Card>
    );
};
